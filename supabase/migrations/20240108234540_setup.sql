...
AS $$
DECLARE
  project_url TEXT := 'https://ctohrneabqgfmbemfkmf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN0b2hybmVhYnFnZm1iZW1ma21mIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczODk0NDgxMywiZXhwIjoyMDU0NTIwODEzfQ.SmIB5JFrt-X7vVKCydOaKPBYkgtWisIK26uBs4wde_s'; -- full access needed for http request to storage
